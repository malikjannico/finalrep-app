...
void main() {
  group('R5 Competition Creation Wizard & Custom Fields Tests', () {
    test(
      'Competition Model - JSON Serialization/Deserialization for R5 Fields',
      () {
        final json = {
          'id': 'comp-r5-1',
    ...
    testWidgets(
      'Widget Test - Competition Creation Wizard navigation and validation',
      (tester) async {
    ...
    testWidgets('Widget Test - Volunteer Application flow on detail page', (
      tester,
    ) async {
      final harness = E2ETestHarness();
      await harness.initialize();
