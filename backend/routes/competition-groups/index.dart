...
Future<Response> onRequest(RequestContext context) async {
  switch (context.request.method) {
    case HttpMethod.get:
      ...
      final list = await DbHelper.getCompetitionGroups(associationId);
      return Response.json(body: list);
    case HttpMethod.post:
      final body = await context.request.json() as Map<String, dynamic>;
      final result = await DbHelper.createCompetitionGroup(body);
      return Response.json(statusCode: 201, body: result);
    case HttpMethod.put:
      final body = await context.request.json() as Map<String, dynamic>;
      final result = await DbHelper.updateCompetitionGroup(body);
